...
Failover on the replica virtual machine couldn't be initiated due to
access issues.

Error message: VMM cannot complete the host operation on the
host1.contoso.com server
...
operation again.\
\
**Error code: ** Service error code: 40000     Provider error code:
12700\
\
...
the operation again.\
\
**Error code: ** Service error code: 20008     Provider error code:
12700\
\
...
\
**Error code: ** Service error code: 20013     Provider error code:
12700\
\
...
Error Message: The recovery plan contains virtual machines which are not
ready for planned failover.\
\
...
Error Message: Virtual machine sharepoint-vm1 is not running and is not
powered off. \
\
...
Error Message: The Hyper-V profile isn't enabled in the Capability
Profiles for cloud CHICAGOCLOUD. \
\
...
Error Message: Hyper-V host cluster HRMBROKER01.contoso.com contains at
least one static network adapter, or no connected adapters are
configured to use DHCP.\
\
**Error code: ** Service error code: 10003     Provider error code:
12700 **Resolution: ** Create a Hyper-V Replica broker resource manually
...
Error Message: Hyper-V host cluster %DRAClusterName; contains at least
one static network adapter, or no connected adapters are configured to
use DHCP.\
\
**Error code: ** Service error code: 67508     Provider error code:
31207\
\
...
Recommendation Configure the virtual machine as generation-1 and then
retry the operation.\
**Error code:** 70009

**Resolution: ** Generation 2 (Gen 2) VMs are not currently for ASR. You
...
Error Message: Enabling protection couldn't be completed for the virtual
machine.
